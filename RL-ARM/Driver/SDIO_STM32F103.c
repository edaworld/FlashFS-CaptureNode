...
*	版    本 : V1.0
*	说    明 : 本文件来自KEIL官方，为支持V4开发板，修改地方有二
*              1. Init函数中SD检测引脚改成PC7。
*              2. CheckMedia函数改成使用PC7做检测。
*
*	修改记录 :
*		版本号    日期         作者            说明
...
static BOOL Init (void) {
  ...
  /* Configure PC.7 Card Detect input */
//  GPIOC->CRL  &= ~0xF0000000;
//  GPIOC->CRL  |=  0x40000000;          /* Input with pull-up/pull-down      */
//  GPIOC->ODR  |=  0x00000080;          /* Enable pull up                    */
